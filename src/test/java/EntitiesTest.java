...
public class EntitiesTest {
	...
	public static void main(String[] args) {
		...
		Cliente c2 = new Cliente(null,"Andrea", "Feminino", LocalDate.of(1993, 5, 12),"88243023","Tabuleiro do Norte");
		...
		Usuario u1 = new Usuario(null,"joao","123",1);
		Usuario u2 = new Usuario(null,"pedro","123",1);
